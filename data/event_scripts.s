...
EventScript_StartMenu::
	...
	call_if_set FLAG_SYS_QUEST_MENU_GET, EventScript_StartMenu_ToggleQuestMenu
	...
	case 4, EventScript_StartMenu_QuestMenuAccess
...
EventScript_StartMenu_ToggleDexnav:
	...
	return
EventScript_StartMenu_ToggleQuestMenu:
    dynmultipush StartMenu_Text_QuestMenu, 4
	return  
...
EventScript_StartMenu_DexnavAccess:
    special RemoveExtraStartMenuWindows
	fadescreen FADE_TO_BLACK
	special Script_StartMenu_OpenDexnavMenu
	end
EventScript_StartMenu_QuestMenuAccess:
    special RemoveExtraStartMenuWindows
	fadescreen FADE_TO_BLACK
	special Script_StartMenu_OpenQuestMenu
    end 
