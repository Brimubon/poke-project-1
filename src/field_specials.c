...
{
    CleanupOverworldWindowsAndTilemaps();
    CreateTask(Task_OpenDexNavFromStartMenu, 0); // Display Dexnav
}

void Script_StartMenu_OpenQuestMenu(void)
{
    CleanupOverworldWindowsAndTilemaps();
    CreateTask(Task_QuestMenu_OpenFromStartMenu, 0); //Display Quest Menu
}
