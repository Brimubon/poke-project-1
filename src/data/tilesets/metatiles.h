...
const u16 gMetatiles_NewOutdoor1[] = INCBIN_U16("data/tilesets/secondary/new_outdoor_1/metatiles.bin");
const u16 gMetatileAttributes_NewOutdoor1[] = INCBIN_U16("data/tilesets/secondary/new_outdoor_1/metatile_attributes.bin");
